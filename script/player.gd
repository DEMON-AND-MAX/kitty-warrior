...
const STAMINA_CAPACITY = 15 # maximum stamina
const DASH_CONSUMPTION = 5 # consumed stamina units per one usage
...
func start_dash() -> void:
	...
	curr_stamina_capacity -= DASH_CONSUMPTION
...
func _on_timer_timeout():
	if curr_stamina_capacity < STAMINA_CAPACITY:
		curr_stamina_capacity += 1
